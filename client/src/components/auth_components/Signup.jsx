...
export default function Signup() {
  ...
  const handleSubmit = (e) => {
    ...
    try {
      axios
        .post("/auth/signup", { form, role: "User" })
        .then((response) => {
  ...
  return (
    <>
      <SEO
        ...
        description="Register with us to begin your journey for best placement"
        name="workflow"
        type="article"
      />
                    ...
                    <form action="#" method="POST" className="space-y-6">
                      ...
                      <div className="space-y-1">
                        ...
                        <div className="mt-1 flex relative">
                          ...
                          >
                            {show ? (
                              <EyeSlashIcon className="h-6 w-6 text-gray-600 hover:cursor-pointer" />
                            ) : (
                              <EyeIcon className="h-6 w-6 text-gray-600 hover:cursor-pointer" />
                            )}
                          </button>
                        </div>
                      </div>
                      {/* <User_role onRoleChange={updaterole} /> */}
