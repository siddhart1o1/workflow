...
export default function Home() {
  ...
  return (
    <>
      <SEO
        title="Best way to prepare for placement"
        description="Begin your journey of success by polishing your aptitute and coding skills"
        name="workflow"
        type="article"
      />
      {/* <Helmet>
        <title>Best way to prepare for Interview</title>
        <meta name="description" content="Prepare for worst" />
      </Helmet> */}
      <main className="flex-1 bg-gray-100">
        ...
        <div className="py-6">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
            <div className="py-2">
              <div className="relative bg-white sm:py-6 lg:py-10">
